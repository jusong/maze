...
vector< vector< vector<int> > > mazeMap = {
    {{WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL},
     {ROAD, ROAD, WALL, ROAD, ROAD, ROAD, ROAD, WALL},
     ...
     {WALL, ROAD, ROAD, ROAD, WALL, WALL, ROAD, WALL, WALL, WALL, ROAD, WALL},
     {WALL, ROAD, WALL, WALL, WALL, WALL, ROAD, ROAD, ROAD, WALL, ROAD, ROAD},
